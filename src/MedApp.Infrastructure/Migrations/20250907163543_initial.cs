    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Dr. Smith", true, "General" },
                    { 2, "Dr. Brown", true, "Endocrinology" }
                });

            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "Id", "IsActive", "Name", "Unit" },
                values: new object[,]
                {
                    { 1, true, "Paracetamol", "500mg" },
                    { 2, true, "Metformin", "850mg" },
                    { 3, true, "Amoxicillin", "250mg" }
                });

            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "Id", "Email", "FullName", "IsActive", "Phone" },
                values: new object[,]
                {
                    { 1, "john@example.com", "John Doe", true, "111" },
                    { 2, "jane@example.com", "Jane Smith", true, "222" }
                });
